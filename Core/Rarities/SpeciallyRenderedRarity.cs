...
namespace Luminance.Core.Rarities;
...
public abstract class SpeciallyRenderedRarity : ModRarity
{
    ...
    private sealed class SpeciallyRenderedRarityImplementation : GlobalItem
    {
        ...
        public override bool PreDrawTooltipLine(Item item, DrawableTooltipLine line, ref int yOffset)
        {
            ...
            if (RarityLoader.GetRarity(item.rare) is not SpeciallyRenderedRarity rarity)
            {
                return true;
            }
            
            rarity.RenderRarityText(Main.spriteBatch, line.Font, line.Text, new Vector2(line.X, line.Y), line.Color, line.Rotation, line.Origin, line.BaseScale, SpriteEffects.None, line.MaxWidth, line.Spread, true);
            return false;
        }
